    ...
    return (
        <div className="xl:px-36 sm:mt-16 md:px-10 px-5 lg:w-10/12 mx-auto">
            <form onSubmit={handleSubmit}>
               ...
               mt-10 text-[14px] font-medium text-white px-5 pb-0.5 h-8 flex items-center justify-center border border-[#748E63] dark:border-[#F9B572] text-[#748E63]   rounded-full hover:bg-[#748E63] dark:hover:bg-[#F9B572]  bg-[#748E63]   dark:bg-[#F9B572] dark:hover:bg-transparent dark:text-black  dark:hover:text-[#F9B572] hover:bg-transparent hover:text-[#789365]  `}
