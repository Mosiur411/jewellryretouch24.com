      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="https://jewelleryretouch24.com/" class="flex items-center">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Payment Method</h2>
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                  <a href="https://jewelleryretouch24.com/" class="hover:underline">Paypal</a>
                </li>
                <li class="mb-4">
                  <a href="https://jewelleryretouch24.com/" class="hover:underline">Bank Transfer</a>
                </li>
                <li class="mb-4">
                  <a href="https://jewelleryretouch24.com/" class="hover:underline">Credit/Debit Card</a>
                </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://jewelleryretouch24.com/" class="hover:underline">jewelleryretouch24</a>. All Rights Reserved.
          </span>
          ...
          <div class="flex mt-4  gap-3 sm:justify-center sm:mt-0">
            ...
            <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <span class="sr-only">Skype page</span>
            </a>
          </div>
