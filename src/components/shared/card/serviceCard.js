...
export default function ServiceCard({ service }) {
    ...
    return (
        <div
            className={`bg-white dark:bg-[#1c1c1c] shadow-md shadow-gray-100 dark:shadow-[#0e0e0e] rounded-xl ${
        ...
        >
            ...
            <div className="w-full md:w-1/2 relative  overflow-hidden rounded-t-xl md:rounded-none">
                <Image
                    ...
                    className="min-w-full rounded-t-xl md:rounded-none"
                />
            </div>

            {/* Content Section */}
            <div
                className={`p-4 md:w-1/2 border md:rounded-b-none rounded-b-xl dark:border-gray-800 ${
