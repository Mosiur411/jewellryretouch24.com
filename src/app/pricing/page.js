...
export const metadata = {
  title: "Pricing - Photoeditspecialist",
  description: "View Photoeditspecialist pricing plans for professional jewelry retouching services. Choose the plan that best fits your needs and budget.",
};
